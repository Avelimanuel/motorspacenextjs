...
const SearchResultsPage = async ({ searchParams }) => {
  ...
  const vehicleQueryResults = await LocallyUsedVehicles.find(query).lean();
    ...
    <>
      ...
      <section className="px-4 py-6">
        <div className="container-xl lg:container m-auto px-4 py-6">
            <Link href="/locallyused" className="mb-3 hover:underline flex items-center text-blue-500">
